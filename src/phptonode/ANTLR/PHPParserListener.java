...
public interface PHPParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link PHPParser#andOrExpression}.
	 * @param ctx the parse tree
	 */
	void enterAndOrExpression(PHPParser.AndOrExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link PHPParser#andOrExpression}.
	 * @param ctx the parse tree
	 */
	void exitAndOrExpression(PHPParser.AndOrExpressionContext ctx);
	/**
	 * Enter a parse tree produced by {@link PHPParser#comparisonExpression}.
	 * @param ctx the parse tree
	 */
	void enterComparisonExpression(PHPParser.ComparisonExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link PHPParser#comparisonExpression}.
	 * @param ctx the parse tree
	 */
	void exitComparisonExpression(PHPParser.ComparisonExpressionContext ctx);
	/**
	 * Enter a parse tree produced by {@link PHPParser#additionExpression}.
	 * @param ctx the parse tree
	 */
	void enterAdditionExpression(PHPParser.AdditionExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link PHPParser#additionExpression}.
	 * @param ctx the parse tree
	 */
	void exitAdditionExpression(PHPParser.AdditionExpressionContext ctx);
	/**
	 * Enter a parse tree produced by {@link PHPParser#multiplicationExpression}.
	 * @param ctx the parse tree
	 */
	void enterMultiplicationExpression(PHPParser.MultiplicationExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link PHPParser#multiplicationExpression}.
	 * @param ctx the parse tree
	 */
	void exitMultiplicationExpression(PHPParser.MultiplicationExpressionContext ctx);
	/**
