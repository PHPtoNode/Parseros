...
public interface PHPParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PHPParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExpression(PHPParser.ExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link PHPParser#andOrExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAndOrExpression(PHPParser.AndOrExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link PHPParser#comparisonExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComparisonExpression(PHPParser.ComparisonExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link PHPParser#additionExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAdditionExpression(PHPParser.AdditionExpressionContext ctx);
	/**
	 * Visit a parse tree produced by {@link PHPParser#multiplicationExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMultiplicationExpression(PHPParser.MultiplicationExpressionContext ctx);
	/**
