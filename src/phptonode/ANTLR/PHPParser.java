package phptonode.ANTLR;// Generated from PHPParser.g4 by ANTLR 4.5.3
...
public class PHPParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "phptonode/ANTLR/PHPParser.g4"; }
	...
	public final NamespaceDeclarationContext namespaceDeclaration() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(342);
				_la = _input.LA(1);
				if (((((_la - 40)) & ~0x3f) == 0 && ((1L << (_la - 40)) & ((1L << (Abstract - 40)) | (1L << (Array - 40)) | (1L << (As - 40)) | (1L << (BinaryCast - 40)) | (1L << (BoolType - 40)) | (1L << (BooleanConstant - 40)) | (1L << (Break - 40)) | (1L << (Callable - 40)) | (1L << (Case - 40)) | (1L << (Catch - 40)) | (1L << (Class - 40)) | (1L << (Clone - 40)) | (1L << (Const - 40)) | (1L << (Continue - 40)) | (1L << (Declare - 40)) | (1L << (Do - 40)) | (1L << (DoubleCast - 40)) | (1L << (DoubleType - 40)) | (1L << (Echo - 40)) | (1L << (Else - 40)) | (1L << (ElseIf - 40)) | (1L << (Empty - 40)) | (1L << (EndDeclare - 40)) | (1L << (EndFor - 40)) | (1L << (EndForeach - 40)) | (1L << (EndIf - 40)) | (1L << (EndSwitch - 40)) | (1L << (EndWhile - 40)) | (1L << (Eval - 40)) | (1L << (Exit - 40)) | (1L << (Extends - 40)) | (1L << (Final - 40)) | (1L << (Finally - 40)) | (1L << (FloatCast - 40)) | (1L << (For - 40)) | (1L << (Foreach - 40)) | (1L << (Function - 40)) | (1L << (Global - 40)) | (1L << (Goto - 40)) | (1L << (If - 40)) | (1L << (Implements - 40)) | (1L << (Import - 40)) | (1L << (Include - 40)) | (1L << (IncludeOnce - 40)) | (1L << (InstanceOf - 40)) | (1L << (InsteadOf - 40)) | (1L << (Int8Cast - 40)) | (1L << (Int16Cast - 40)) | (1L << (Int64Type - 40)) | (1L << (IntType - 40)) | (1L << (Interface - 40)) | (1L << (IsSet - 40)) | (1L << (List - 40)) | (1L << (LogicalAnd - 40)) | (1L << (LogicalOr - 40)) | (1L << (LogicalXor - 40)) | (1L << (Namespace - 40)) | (1L << (New - 40)) | (1L << (Null - 40)) | (1L << (ObjectType - 40)) | (1L << (Parent_ - 40)) | (1L << (Partial - 40)) | (1L << (Print - 40)))) != 0) || ((((_la - 104)) & ~0x3f) == 0 && ((1L << (_la - 104)) & ((1L << (Private - 104)) | (1L << (Protected - 104)) | (1L << (Public - 104)) | (1L << (Require - 104)) | (1L << (RequireOnce - 104)) | (1L << (Resource - 104)) | (1L << (Return - 104)) | (1L << (Static - 104)) | (1L << (StringType - 104)) | (1L << (Switch - 104)) | (1L << (Throw - 104)) | (1L << (Trait - 104)) | (1L << (Try - 104)) | (1L << (Typeof - 104)) | (1L << (UintCast - 104)) | (1L << (UnicodeCast - 104)) | (1L << (Use - 104)) | (1L << (Var - 104)) | (1L << (While - 104)) | (1L << (Yield - 104)) | (1L << (Get - 104)) | (1L << (Set - 104)) | (1L << (Call - 104)) | (1L << (CallStatic - 104)) | (1L << (Constructor - 104)) | (1L << (Destruct - 104)) | (1L << (Wakeup - 104)) | (1L << (Sleep - 104)) | (1L << (Autoload - 104)) | (1L << (IsSet__ - 104)) | (1L << (Unset__ - 104)) | (1L << (ToString__ - 104)) | (1L << (Invoke - 104)) | (1L << (SetState - 104)) | (1L << (Clone__ - 104)) | (1L << (DebugInfo - 104)) | (1L << (Namespace__ - 104)) | (1L << (Class__ - 104)) | (1L << (Traic__ - 104)) | (1L << (Function__ - 104)) | (1L << (Method__ - 104)) | (1L << (Line__ - 104)) | (1L << (File__ - 104)) | (1L << (Dir__ - 104)))) != 0) || _la==Label) {
					{
					setState(341);
					namespaceNameList();
					}
	...
	public static final String _serializedATN =
		...
		"J\6\2*8:y{\u0096\u00d4\u00d4\6\2**JJjlqq\3\2\u008f\u0096\3\2\177\u008e"+
		"\t\2++..<<[\\ffoorr\13\2++-.;<LLY\\ffoorrxz\u06f2\2\u010d\3\2\2\2\4\u011a"+
